...
export default function UCReport({ user }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append('report_type', 'UC');
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl p-6 shadow-lg">
        <h2 className="text-2xl font-bold mb-2">UC Report</h2>
        <p className="text-purple-100">Upload UC EOD ZIP file (Type "N" for enrollment)</p>
      </div>
      ...
      {result && (
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="bg-green-50 border border-green-200 text-green-800 px-6 py-4 rounded-xl flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold">UC Report Uploaded Successfully!</p>
